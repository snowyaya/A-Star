...
// Query 1: This recommendation query to recommend the categories of the startup companies
app.get("/recommendation/company-category", routes.company_category_recommendations)

// Query 2: This recommendation query to recommend the location of the startup companies
...
/* Query 4: This demonstration query to show the Top VC's targeted industries */
// app.get("/VC_funding/:investorId", routes.get_VC_category)
app.get("/VC_funding", routes.get_VC_category)

// Query 5: This demonstration query to show the heatmap of geographical distribution of the companies in different states in USA
